            ...
            <div class="messages-left col-sm-5  col-md-4" >
              ...
              <div class="message-list-menu">
                <div class="btn-group btn-group-justified">
                  ...
                  <a class="btn btn-default" data-toggle="mainmodal" role="button" href="<?=base_url()?>messages/write" title="<?=$this->lang->line('application_write_message');?>"><i class="fa fa-envelope-o"></i></a>
                </div>
