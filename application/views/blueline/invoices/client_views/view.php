...
<button href="<?=base_url()?>cinvoices/stripepay/<?=$invoice->id;?>" class="btn btn-primary" data-toggle="mainmodal"><?=$this->lang->line('application_pay_with_credit_card');?></button>
<?php } ?>
</span>
...
<span class="pull-right">
			<?php if($core_settings->paypal == "1" && $sum != "0.00" && empty($invoice->paid_date)){ ?><br/>
						...
						<input type="hidden" name="return" value="<?=base_url()?>cinvoices/view/<?=$invoice->id;?>"> 
						...
						<input type="hidden" name="custom" value="cinvoice-<?=$sum;?>">     
						</form>
						<?php } ?>
</span>	
<br>
