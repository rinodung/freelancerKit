...
<div class="col-sm-12  col-md-12"> 
		...
		<div class="table-div">
			...
			<div class="question"><?=$this->lang->line('quotation_question_4');?></div> <div class="answer"><?php if(isset($quotation->q4)){echo $quotation->q4;}else{echo "-";};?></div>
			<div class="question"><?=$this->lang->line('quotation_question_5');?></div> <div class="answer"><?php if(isset($quotation->q5)){echo $quotation->q5;}else{echo "-";};?></div>
